...
public static class Stages
{
    ...
    static Stages()
    {
        ...
        // rows of rise per tile of run per side until it is 11 across, then straight up to
        // the summit Zeus is rooted on. There is no interior and no stair — the outside
        // face IS the route, climbed and/or built up.
        //
