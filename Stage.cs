...
public static class Stages
{
    ...
    static Stages()
    {
        ...
        // scripts/gen-tower.py). Solid stone: 37 tiles across where it meets the plain,
        // tapering three rows of rise per tile of run per side until it is 11 across,
        // then straight up to the summit Zeus is rooted on. There is no interior and no
        // stair — the outside face IS the route, climbed and/or built up.
        //
        ...
        // EnemyAim.HasLineOfSight). Zeus is the summit; the tower is the birds.
        Register(new Stage {
            Name          = "hill",
    ...
    private const int TowerSpireHalf   = 5;    // 11 tiles across above the taper
    ...
    private static int TowerHalfAt(int gty)
    {
        ...
        return Math.Max(TowerSpireHalf, TowerBaseHalf - rise / TowerTaperRise);
    }
