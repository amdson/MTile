...
public static class Stages
{
    ...
    static Stages()
    {
        ...
        // then easing off and dwindling the rest of the way to the single tile Zeus is
        // rooted on. There is no interior and no stair — the outside face IS the route,
        // climbed and/or built up.
        //
