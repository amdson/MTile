...
| Surface detection | [Character/Sensing/CeilingChecker.cs](Character/Sensing/CeilingChecker.cs), [GroundChecker.cs](Character/Sensing/GroundChecker.cs), [WallChecker.cs](Character/Sensing/WallChecker.cs), [ExposedUpperCornerChecker.cs](Character/Sensing/ExposedUpperCornerChecker.cs), [ExposedLowerCornerChecker.cs](Character/Sensing/ExposedLowerCornerChecker.cs) | All five build a region via `body.Bounds.StripXxx(...)` and call `TileQuery.SolidTilesInRect`. None of them know about anything but tiles. |
